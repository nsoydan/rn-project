import { View, Text,SafeAreaView,StyleSheet,StatusBar,FlatList,TouchableOpacity, Alert,Button,Modal,Pressable } from 'react-native'
...
function TodoScreen({route,navigation}) {
    ...
    console.log("tooooooooooooooooooooooooooooddddoooooooossss",datafromtodoslice)
    ...
    const Item = ({talepAciklama,id,bakimKayitTarihSaat,talepEden,durum,isAciklama,sehir,firma}) => (
        <TouchableOpacity onPress={()=>navigation.navigate('TodoDetailScreen',{id:id})} >
    ...
    const renderItem = ({ item }) => (
        <Item   talepAciklama={item.talepAciklama}
                id={item.id}
